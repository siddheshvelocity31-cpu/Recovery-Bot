...
/**
 * Link styled consistently with Button — use where an action is a navigation
 * but should look like a button.
 */
export function PageLink({ href, variant = "primary", size = "md", className, children }: PageLinkProps) {
  return (
    <Link
      href={href}
      className={cn(
